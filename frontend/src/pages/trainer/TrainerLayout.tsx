...
export const TrainerLayout: React.FC = () => {
    ...
    return (
      <Container maxWidth="sm" sx={{ mt: 10, textAlign: 'center' }}>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
          You must sign in as a trainer to access this portal.
        </Typography>
        <Button
          variant="contained"
          component={Link}
  ...
  if (role !== 'trainer' && role !== 'owner') {
    return (
      <Container maxWidth="sm" sx={{ mt: 10, textAlign: 'center' }}>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ mb: 2 }}>
          Only trainers or owners are permitted to access the trainer console.
        </Typography>
        <Button
          variant="outlined"
          component={Link}
  ...
  const navItems = [
    { label: 'Overview', path: '/trainer/dashboard' },
